...
function updatetags (data) {
  ...
  let original = `<img src="/${data.prn_path}" class="responsive" alt="${data.judgment_scence_result}" figcaption="${data.judgment_scence_result}">
  <figcaption>${data.judgment_scence_result}</figcaption>
  <audio controls autoplay src="${data.sound_path}">
  `;
